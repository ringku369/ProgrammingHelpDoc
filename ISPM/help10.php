...
# 
### Direct Income Or Expense Step - 2
#
...
accjournalaccounts as t1 where t1.accstatus = 3 and t1.relation = 1 and t1.branch_id = @brid

), 

cte2 as (
select sum(t1.clbcredit) as tcredit  from 
accjournalaccounts as t1 where t1.accstatus = 3 and t1.relation = 0 and t1.branch_id = @brid
...
where t1.accstatus = 4 and t1.relation = 1 and t1.branch_id = @brid
), 

cte4 as (
select sum(t1.clbdebit) as tdebit
from accjournalaccounts as t1
where t1.accstatus = 4  and t1.relation = 0  and t1.branch_id = @brid
),

cte5 as (
select sum(t1.clbcredit) as tcredit 
from accjournalaccounts as t1
where t1.accstatus = 3 and t1.type = 2 and t1.branch_id = @brid
),

cte6 as (
select sum(t1.clbdebit) as tdebit 
from accjournalaccounts as t1
where t1.accstatus = 4 and t1.type = 2 and t1.branch_id = @brid
),
