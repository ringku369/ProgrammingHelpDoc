$(function () {
    if ($("select[name='nationality']").find('option:selected').attr('data-required') == 'True'){
        $("input[name='national_id']").prev("label").find(".optional").hide();
    }
    $("select[name='nationality']").on('change', function(event){
        if ($(this).children("option:selected").attr('data-required') == "True"){
            $("input[name='national_id']").prev("label").find(".optional").hide()
        }
        else{
            $("input[name='national_id']").prev("label").find(".optional").show()
        }
    });
