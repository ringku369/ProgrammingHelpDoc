  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{ route('admin.brand') }}">Brand</a></li>
      </ol>
    </section>
...
@foreach ($brands as $key=>$element)
                ...
                <tr>
                  ...
                  <td>
                <!--  
                   <a href="#" class=" btn btn-warning btn-md" data-toggle="modal" data-target="#{{'brandUpdateModal'. $element['id']}}">Edit</a> 
                   <a href="#" class=" btn btn-danger btn-md" data-target="#{{'brandDeleteModal'. $element['id']}}">Delete</a> 
                 -->
